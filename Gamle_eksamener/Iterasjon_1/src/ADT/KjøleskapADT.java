...
public interface KjøleskapADT {

	/**
	 * Legger til varen som har id som blir satt som parameter. Dersom varen finnes i kjøleskap fra før, skal antall av denne varen økes,
	...
	/**
	 * fjerner en vare med id gitt som parameter, dersom denne varen ikkje finnes i kjøleskapet gjør den ingenting
	 * @param id
	...
	/*
	 * returnerer en liste med alle varer som kjøleskapet inneholder
	 */
	public Set<Vare> getAlle();
	/**
	 * Oppdaterer antall til en bestemt vare
	 * @param vare varen som skal oppdateres
	 * @param antall nye antallet av varen i kjøleskapet
	 */
